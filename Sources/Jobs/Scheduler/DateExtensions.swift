...
extension Date {
    ...
    /// ex.  month -> dayOfMonth value is set  to 1, hour value is set to 0, minute value is set to 0, second value is set to 0
    ...
    // Finds how many units to add to get to the next value
    // i.e if ruleTimeUnit = .seconds, currentValue = 55, and nextValue = 5 then 9 would be returned
