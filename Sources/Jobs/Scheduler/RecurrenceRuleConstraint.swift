...
internal struct SpecificRecurrenceRuleConstraintFactory {
    internal static func createSpecificSetConstraint(for timeUnit: RecurrenceRule.TimeUnit, value: Int) throws -> SpecificRecurrenceRuleConstraint {
    ...
    static internal func createSpecificSetConstraint(for timeUnit: RecurrenceRule.TimeUnit, values: Set<Int>) throws -> SpecificRecurrenceRuleConstraint {
        let typeObject = resolveSpecificRecurrenceRuleConstraintTypeObject(for: timeUnit)
        return try typeObject.init(constraint: RecurrenceRuleSetConstraint.init(timeUnit: typeObject.timeUnit,
                                                                                setConstraint: values))
    }

    static internal func createSpecificStepConstraint(for timeUnit: RecurrenceRule.TimeUnit, stepValue: Int) throws -> SpecificRecurrenceRuleConstraint {
        let typeObject = resolveSpecificRecurrenceRuleConstraintTypeObject(for: timeUnit)
    ...
    static internal func createSpecificRangeConstraint(for timeUnit: RecurrenceRule.TimeUnit, range: ClosedRange<Int>) throws -> SpecificRecurrenceRuleConstraint {
        let typeObject = resolveSpecificRecurrenceRuleConstraintTypeObject(for: timeUnit)
        return try typeObject.init(constraint: RecurrenceRuleRangeConstraint.init(timeUnit: typeObject.timeUnit,
                                                                                 rangeConstraint: range))
    }

    private static func resolveSpecificRecurrenceRuleConstraintTypeObject(for timeUnit: RecurrenceRule.TimeUnit) -> SpecificRecurrenceRuleConstraint.Type {
        switch timeUnit {
        case .year:
